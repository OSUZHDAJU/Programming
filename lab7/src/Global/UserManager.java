...
public class UserManager {
    ...
    private transient Scanner userScanner;
    ...
    public String askUser(){
        ...
        while (true){
            try{
                ...
                user = userScanner.nextLine().trim();
                if (user.equals("")) throw new ShouldNotBeEmptyException();
                break;
            } catch (ShouldNotBeEmptyException e){
                System.out.println("error: Логин не может быть пустым!");
            }
        }
        return user;
    }
    ...
    public String askPass(){
        ...
        while (true){
            try{
                ...
                pass = userScanner.nextLine().trim();
                if (pass.equals("")) throw new ShouldNotBeEmptyException();
                break;
            } catch (ShouldNotBeEmptyException e){
                System.out.println("error: Пароль не может быть пустым!");
            }
        }
        return pass;
    }
