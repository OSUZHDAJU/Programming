...
import Exceptions.OutOfBoundsExeption;
import Exceptions.ShouldNotBeEmptyException;
import data.*;
    ...
    public float askY() throws IncorrectInputException {
        ...
        while (true){
            try{
                ...
                if(y > max_y) throw new OutOfBoundsExeption();
                break;
            } catch (NoSuchElementException e){
    ...
    public long askMinimalPoint() throws IncorrectInputException {
        ...
        while (true){
            try{
                ...
                if(point<min_minimalPoint) throw new OutOfBoundsExeption();
                break;
            } catch (NoSuchElementException e){
